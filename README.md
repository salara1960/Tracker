...
* Устройство инициализирует некоторые интерфейсы микроконтроллера :
  - GPIO : подключен сетодиод PB12 - секундный тик, pps сигнал с GPS модуля PA1, кнопка спящего режима PA0 (работает как триггер).
...
```
rst
14.09 13:17:28 | Restart...

14.09 13:05:01 | GPS app ver.06. ChipID:0x35E0611, SystemClk:48000000Hz, Seconda:1789391101
```
